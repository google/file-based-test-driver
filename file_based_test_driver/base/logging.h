...
#ifndef THIRD_PARTY_FILE_BASED_TEST_DRIVER_BASE_LOGGING_H_
#define THIRD_PARTY_FILE_BASED_TEST_DRIVER_BASE_LOGGING_H_
...
#define FILE_BASED_TEST_DRIVER_INTERNAL_LOGGING_INFO                    \
  ::file_based_test_driver_base::logging_internal::LogMessage(__FILE__, \
                                                              __LINE__)
#define FILE_BASED_TEST_DRIVER_INTERNAL_LOGGING_WARNING        \
  ::file_based_test_driver_base::logging_internal::LogMessage( \
      __FILE__, __LINE__, absl::LogSeverity::kWarning)
#define FILE_BASED_TEST_DRIVER_INTERNAL_LOGGING_ERROR          \
  ::file_based_test_driver_base::logging_internal::LogMessage( \
      __FILE__, __LINE__, absl::LogSeverity::kError)
#define FILE_BASED_TEST_DRIVER_INTERNAL_LOGGING_FATAL                        \
  ::file_based_test_driver_base::logging_internal::LogMessageFatal(__FILE__, \
                                                                   __LINE__)

#define FILE_BASED_TEST_DRIVER_INTERNAL_LOGGING_QFATAL \
  FILE_BASED_TEST_DRIVER_INTERNAL_LOGGING_FATAL

#ifdef NDEBUG
#define FILE_BASED_TEST_DRIVER_INTERNAL_LOGGING_DFATAL \
  FILE_BASED_TEST_DRIVER_INTERNAL_LOGGING_ERROR
#else
#define FILE_BASED_TEST_DRIVER_INTERNAL_LOGGING_DFATAL \
  FILE_BASED_TEST_DRIVER_INTERNAL_LOGGING_FATAL
#endif
...
#ifdef NDEBUG
#define FILE_BASED_TEST_DRIVER_DEBUG_MODE false
#else
#define FILE_BASED_TEST_DRIVER_DEBUG_MODE true
#endif
...
#define FILE_BASED_TEST_DRIVER_INTERNAL_CHECK_OP(name, op, val1, val2)        \
  while (std::unique_ptr<std::string> _result = std::unique_ptr<std::string>( \
             ::file_based_test_driver_base::name##Impl(                       \
                 ::file_based_test_driver_base::GetReferenceableValue(val1),  \
                 ::file_based_test_driver_base::GetReferenceableValue(val2),  \
                 #val1 " " #op " " #val2)))                                   \
  ::file_based_test_driver_base::logging_internal::LogMessageFatal(           \
...
#endif  // THIRD_PARTY_FILE_BASED_TEST_DRIVER_BASE_LOGGING_H_
