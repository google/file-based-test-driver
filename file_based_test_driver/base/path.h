...
#ifndef THIRD_PARTY_FILE_BASED_TEST_DRIVER_BASE_PATH_H_
#define THIRD_PARTY_FILE_BASED_TEST_DRIVER_BASE_PATH_H_
...
// Usage:
// string path =
//     file_based_test_driver_base::JoinPath(getenv("TEST_SRCDIR"), filename);
//
...
//
// Usage:
// string path = JoinPathRespectAbsolute("/f", dirname, filename);
template <typename... T>
...
#endif  // THIRD_PARTY_FILE_BASED_TEST_DRIVER_BASE_PATH_H_
