...
#ifndef THIRD_PARTY_FILE_BASED_TEST_DRIVER_BASE_STATUSOR_INTERNALS_H_
#define THIRD_PARTY_FILE_BASED_TEST_DRIVER_BASE_STATUSOR_INTERNALS_H_
...
#endif  // THIRD_PARTY_FILE_BASED_TEST_DRIVER_BASE_STATUSOR_INTERNALS_H_
